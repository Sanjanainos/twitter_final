...
while True:
    user = api.get_user('Sanjana0506')
    api.update_profile(name=f'sanjana|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : sanjana|{follower_count(user)} Followers')
